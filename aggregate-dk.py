...
week = str(week)
csv_output = "weeks/week-" +week + "/aggregate-week" + week + "dk.csv"

dk_file = "weeks/week-" +week + "/DKweek" +week +"salaries.xlsx"

#each site
ff_csv = "weeks/week-" +week + "/fftoday-week" + week + "-dk.csv"
espn_csv = "weeks/week-" +week + "/espn-week" + week + "-dk.csv"
fl_csv = "weeks/week-" +week + "/fleaflicker-week" + week + "-dk.csv"
nfl_csv = "weeks/week-" +week + "/nfl-week" + week + "-dk.csv"
cbs_csv = "weeks/week-" +week + "/cbs-week" + week + "-dk.csv"
fox_csv = "weeks/week-" +week + "/fox-week" + week + "-dk.csv"
fire_csv = "weeks/week-" +week + "/fire-week" + week + "-dk.csv"
def_csv = "weeks/week-" +week + "/def-week" +week + "-dk.csv"
...
df = s7[['Name','Position','Salary','GameInfo','AvgPointsPerGame','teamAbbrev','fftoday','nfl','cbs','fleaflicker','espn','fire']]
