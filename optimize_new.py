...
lu_headings = [['QB','QB_sal','QB_score','RB1','RB2','RB_sal','RB_score','WR1','WR2','WR3','WR_sal','WR_score','TE','TE_sal','TE_score','FLEX','FLEX_sal','FLEX_score','salary','score']]
...
perms = qb_num*rb_num*wr_num*te_num*flex_num
...
f = 0
max_score = 0
max_sal = 47000 # an input for the function
...
#				for d in range(0,dst_num):
				for f in range(0,flex_num):
					data = [qb[q][0],qb[q][1],qb[q][2],rb[r1][0],rb[r1][1],rb[r1][2],rb[r1][3],wr[w1][0],wr[w1][1],wr[w1][2],wr[w1][3],wr[w1][4],te[t][0],te[t][1],te[t][2],flex[f][0],flex[f][1],flex[f][2],0,0]
